    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <div class="divide-y divide-gray-50">
                ...
                @empty
                <p class="p-6 text-gray-500 text-center">No archived papers yet.</p>
                @endforelse
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
            <div class="p-6 border-b border-gray-100">
                <h3 class="font-bold text-gray-800 text-lg">Papers by College</h3>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="{{ route('research.index') }}" class="flex flex-col items-center bg-orange-50 hover:bg-orange-100 rounded-xl p-5 transition">
                <i class="fas fa-archive text-orange-600 text-2xl mb-2"></i>
                <span class="text-sm font-semibold text-gray-700">Browse Archive</span>
            </a>
